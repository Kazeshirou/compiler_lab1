...
//                     part[i]
//                         .size());  /// Transitions for the states of
//                         partitions
//                 /// Iterate over states of partitions and find transition
//                 groups for (int k = 0; k < part[i].size(); k++) {
//                     if (dfa[part[i][k]].a[j] >= 0)
//                         trans[k] =
//                             make_pair(grp[dfa[part[i][k]].a[j]], part[i][k]);
//                     else
...
//                     for (k = 1; k < trans.size() and
//                                 (trans[k].first == trans[k - 1].first);
//                          k++) {
...
//     cout << "---------------------------------------------------------" <<
//     endl; cout << "State\t|\tA\t|\tB\t|\tFinal\t|" << endl; cout <<
//     "---------------------------------------------------------" << endl; for
//     (int i = 0; i < (int)min_dfa.size(); i++) {
//         cout << i << "\t|\t";
...
//     pair<int, vector<tuple<int, int, bool> > > min_dfa_tmp =
//     minimize_dfa(dfa);
